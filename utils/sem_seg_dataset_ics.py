...
from .utils import ICS_ANSWER_LIST, ICS_SHORT_QUESTION_LIST
...
class SemSegDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.short_question_list = ICS_SHORT_QUESTION_LIST
        self.answer_list = ICS_ANSWER_LIST
    ...
    def __getitem__(self, idx):
        ...
        for sampled_cls in sampled_classes:
            ...
            answers.append(random.choice(self.answer_list).format(class_name=text.lower()))
